    ...
    public static void main(String[] args) {
        ...
        """ + ColorConstants.RESET);
                ...
                switch (roleChoice) {
                    ...
                    default -> System.out.println(ColorConstants.RED + "❗ Invalid role number. Please select 1, 2, or 3." + ColorConstants.RESET);
                }
            }
            ...
            default -> System.out.println(ColorConstants.RED + "❗ Invalid choice. Please select a valid option." + ColorConstants.RESET);
        }
    }
}